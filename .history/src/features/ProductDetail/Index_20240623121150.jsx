...
export default function ProductDetail() {
  ...
  const getProductDetailRequest = GetProductDetailRequest(
    searchParams.get("id")
  );
  const getProductVariantDetailRequest = GetProductVariantDetailRequest(
    searchParams.get("id")
  );
  ...
  return (
    <ProductSingleContainer>
      <BreadCrumb>
        <Link>Home</Link> <FaAngleRight /> <Link>Product list</Link>{" "}
        <FaAngleRight />
        <Link>{getProductDetailRequest.data.data.category.name}</Link>{" "}
        <FaAngleRight />
      ...
      />
      <ProductReview src/features/ProductDetail/Index.jsx />
      <ProductRelated />
    </ProductSingleContainer>
  );
}
